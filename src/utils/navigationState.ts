export type AppPage = 'staff' | 'ipd' | 'admin' | 'fdh' | 'fdhImport' | 'nhsoClose' | 'repstm' | 'receivable' | 'repDeny' | 'specific' | 'monitor' | 'guide' | 'settings' | 'authenSync' | 'preValidator' | 'workQueue' | 'rejectTracking';
