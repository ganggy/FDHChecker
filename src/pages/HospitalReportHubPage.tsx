...
const reports: ReportDefinition[] = [
  ...
  { id: 'referral-report', category: 'clinical', title: 'รายงานรับและส่งต่อผู้ป่วย', english: 'Referral Summary', description: 'จำนวน Refer in/out แยกสถานพยาบาลต้นทางและปลายทาง', icon: '🚑', status: 'ready', input: 'date', defaultFormat: 'xlsx', requirement: 'เป็นรายงานสรุปจาก referin/referout ไม่ใช่ใบ Refer หรือแบบส่งเวรฉบับลงนาม' },
  ...
  { id: 'daily-service-summary', category: 'operations', title: 'ภาพรวมบริการประจำวัน', english: 'Daily Service Overview', description: 'OPD, รับเข้า–จำหน่าย IPD และค่าใช้จ่ายรายวันในหน้าเดียว', icon: '📅', status: 'ready', input: 'date', defaultFormat: 'xlsx' },
  { id: 'opd-department-workload', category: 'operations', title: 'ภาระงาน OPD แยกแผนก', english: 'OPD Workload', description: 'จำนวนคน จำนวนครั้ง ค่าเฉลี่ยต่อวัน และค่าใช้จ่ายแยกแผนก', icon: '🏃', status: 'ready', input: 'date', defaultFormat: 'xlsx' },
  { id: 'ipd-admission-discharge', category: 'operations', title: 'ทะเบียนรับเข้า–จำหน่าย IPD', english: 'IPD Admission & Discharge', description: 'ทะเบียนผู้ป่วย AN วอร์ด วันนอน DRG RW และค่าใช้จ่าย', icon: '🛌', status: 'ready', input: 'date', defaultFormat: 'xlsx' },
  { id: 'ipd-ward-performance', category: 'operations', title: 'ผลงานผู้ป่วยในแยกวอร์ด', english: 'Ward Performance', description: 'เคสจำหน่าย วันนอน RW และค่าใช้จ่ายเฉลี่ยรายวอร์ด', icon: '🏢', status: 'ready', input: 'date', defaultFormat: 'xlsx' },
  ...
  { id: 'drug-utilization', category: 'operations', title: 'การใช้ยา', english: 'Drug Utilization', description: 'จำนวนจ่าย จำนวนผู้ป่วย และมูลค่ารายการยาเรียงตามปริมาณ', icon: '💉', status: 'ready', input: 'date', defaultFormat: 'xlsx', requirement: 'แสดงรายการจ่ายจาก opitemrece ไม่ใช่ยอดคงคลัง' },
  { id: 'lab-workload', category: 'operations', title: 'ปริมาณงานห้องปฏิบัติการ', english: 'Laboratory Workload', description: 'จำนวนสั่งตรวจ มีผลแล้ว และผลผิดปกติแยกรายการ Lab', icon: '🔬', status: 'ready', input: 'date', defaultFormat: 'xlsx' },
  ...
  { id: 'claim-data-completeness', category: 'quality', title: 'ความครบถ้วนก่อนส่งเคลม', english: 'Claim Data Completeness', description: 'ค้นหา visit ที่ขาด CID สิทธิ วินิจฉัยหลัก หรือยอดค่าใช้จ่าย', icon: '✅', status: 'ready', input: 'date', defaultFormat: 'xlsx', requirement: 'เป็นด่านพื้นฐานก่อนใช้กฎตรวจเฉพาะกองทุนในเมนูตรวจก่อนส่ง' },
  { id: 'opd-diagnosis-ranking', category: 'quality', title: 'อันดับโรคผู้ป่วยนอก', english: 'OPD Diagnosis Ranking', description: 'อันดับวินิจฉัยหลัก จำนวนคน จำนวนครั้ง และสัดส่วนบริการ', icon: '📊', status: 'ready', input: 'date', defaultFormat: 'xlsx' },
  ...
  { id: 'revenue-by-category', category: 'financial', title: 'ค่าใช้จ่ายแยกหมวดบริการ', english: 'Charge by Service Category', description: 'จำนวนรายการ Visit ผู้ป่วย และยอดค่าใช้จ่ายแยกหมวด income', icon: '💰', status: 'ready', input: 'date', defaultFormat: 'xlsx', requirement: 'เป็นราคาค่าบริการที่บันทึก ไม่ใช่รายรับที่รับเงินจริง' },
