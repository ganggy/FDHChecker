...
export const toolNavGroups: NavGroup[] = [
  ...
  { label: 'การเงิน/บัญชี', icon: '💼', pages: ['accountingRevenueBudget', 'revenueOpportunity', 'receivable', 'ucOutsideCup', 'reconciliation', 'repDailySummary', 'ppfsBenchmark', 'ppfsVisitMatch', 'insuranceOverview'] },
