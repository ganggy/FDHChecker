...
const guides: FundGuide[] = [
    {
        id: 'anemia_screening',
        title: 'คัดกรองโลหิตจาง (13001 / CBC+Z138)',
        description: 'กองทุนคัดกรองโลหิตจางในหญิงวัยเจริญพันธุ์ หากพยาบาลลืมลงรหัส 13001 ระบบยังช่วยหาเคสจากผลแล็บและ diagnosis ได้',
        conditions: [
            'หญิงอายุ 13-24 ปี ในช่วงเวลาที่อยู่ในเกณฑ์คัดกรอง',
            'มีผลตรวจ CBC หรือรายการแล็บที่เข้ากลุ่มเลือดครบชุด',
            'มี diagnosis Z138 หรือรหัสคัดกรองโลหิตจางที่ระบบจับได้'
        ],
        codes: ['ADP 13001', 'CBC / Full Blood Count / Hematology', 'ICD-10: Z138'],
