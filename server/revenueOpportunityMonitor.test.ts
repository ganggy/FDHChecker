...
test('only includes explicit OP Refer and CSCD rows in those categories', () => {
  const result = buildRevenueOpportunityMonitor({
    ...
    instrumentRows: [],
    opdRows: [
      { vn: '3', fund: 'บัตรทอง รับส่งต่อต่างจังหวัด OP Refer', has_refer_record: 1, refer_hospcode: '12345', main_diag: 'J189', has_receipt: 1, total_price: 900, has_close: 1 },
      { vn: '4', fund: 'UC ใน CUP', main_diag: 'J189', has_receipt: 1, total_price: 900, has_close: 1 },
      { vn: '7', fund: 'UC ใน CUP', has_refer_record: 1, refer_hospcode: '12345', main_diag: 'J189', has_receipt: 1, total_price: 900, has_close: 1 },
    ],
    ipdRows: [
